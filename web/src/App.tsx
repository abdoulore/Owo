...
const NAV_ROUTES = ["/home", "/send", "/activity"];
...
function App() {
  ...
  return (
    ...
    <div className="app-backdrop min-h-dvh md:flex md:items-center md:justify-center md:p-6">
      <div className="relative mx-auto flex min-h-dvh w-full max-w-[430px] flex-col overflow-hidden bg-cream md:h-[880px] md:min-h-0 md:max-h-[90dvh] md:rounded-[2.5rem] md:border md:border-line md:shadow-2xl md:shadow-black/15">
